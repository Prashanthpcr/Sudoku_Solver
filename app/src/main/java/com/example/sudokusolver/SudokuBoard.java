...
class SudokuBoard extends View {
    ...
    private final int boardBGColor;
    ...
    private final Paint boardBGColorPaint=new Paint();
    ...
    public SudokuBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            boardBGColor=a.getInteger(R.styleable.SudokuBoard_boardBGColor,0);
    ...
    protected void onDraw(Canvas canvas){
        ...
        boardBGColorPaint.setStyle(Paint.Style.FILL);
        boardBGColorPaint.setAntiAlias(true);
        boardBGColorPaint.setColor(boardBGColor);
        ...
        canvas.drawRect(0,0,getMeasuredWidth(),getMeasuredHeight(),boardBGColorPaint);
    ...
    private void drawBoard(Canvas canvas){
        ...
        for (int r=0;r<10;r++){
            ...
            canvas.drawLine(0,cellSize*r,getMeasuredHeight(),cellSize*r,
                    boardColorPaint);
        }
